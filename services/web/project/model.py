...
def key_gen(user, version):
    """
    Every primary key for every record going into any EMPI table is generated by calling this function, affixing
    everything to a common number-line, and data warehousing technique.
    :param user: the username of any db-altering command is stored in the etl id source table
